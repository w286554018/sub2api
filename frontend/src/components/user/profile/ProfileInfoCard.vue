          ...
          <div class="min-w-0 flex-1 space-y-5">
            <div class="space-y-3">
              <div class="flex flex-wrap items-center gap-2">
                ...
                <span :class="['badge', user?.role === 'super_admin' ? 'badge-danger' : user?.role === 'admin' ? 'badge-primary' : 'badge-gray']">
                  {{ user?.role === 'super_admin' ? t('profile.superAdministrator') : user?.role === 'admin' ? t('profile.administrator') : t('profile.user') }}
                </span>
                <span
