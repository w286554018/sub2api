export default {
    ...
    groups: {
      ...
      stats: {
        ...
        description: 'Usage is aggregated by the group recorded when each request happened. Cost fields are split by book cost, billed usage, and upstream account cost to avoid mixing accounting scopes.',
        from: 'Start time',
        to: 'End time (exclusive)',
        refresh: 'Refresh',
        allTime: 'All history',
        loading: 'Calculating…',
        loadFailed: 'Failed to load group statistics',
        invalidTime: '{label} is invalid',
        invalidRange: 'End time must be later than start time',
        totalActualCost: 'Billed usage',
        totalActualCostNote: 'Balance deductions and subscription consumption from historical usage logs',
        totalCost: 'Book cost',
        totalCostNote: 'Standard pricing cost stored on usage logs',
        totalAccountCost: 'Upstream account cost',
        totalAccountCostNote: 'Per-log account cost and historical multipliers, not an upstream invoice',
        totalRequests: 'Logged requests',
        totalTokens: 'Tokens including cache',
        averageDuration: 'Average duration',
        durationMs: '{value} ms',
        totalApiKeys: 'Current API keys',
        activeApiKeys: 'Active unexpired keys',
        totalAccounts: 'Current linked accounts',
        balanceCost: 'Balance billed usage',
        subscriptionCost: 'Subscription billed usage',
        zeroChargeRequests: 'Zero-charge records',
        empty: 'No usage records in the current range.',
        allHistory: 'All historical usage',
        rangeApplied: 'Filtered by the selected time range',
