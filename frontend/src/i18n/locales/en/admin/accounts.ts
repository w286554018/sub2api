export default {
    accounts: {
      ...
      openai: {
        ...
        codexFingerprintConvergence: 'Experimental Codex wire convergence',
        codexFingerprintConvergenceDesc: 'Match Codex session headers, field order, and Responses request compression. Use with an enabled fingerprint mode after validating upstream compatibility.',
