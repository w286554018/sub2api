export default {
    ...
    groups: {
      ...
      stats: {
        ...
        description: '用量按请求发生时的分组归属统计。金额字段分别展示账面费用、实际计费和上游账号成本，避免混用不同口径。',
        from: '开始时间',
        to: '结束时间（不含）',
        refresh: '刷新',
        allTime: '全部历史',
        loading: '正在统计…',
        loadFailed: '无法获取分组统计',
        invalidTime: '{label}格式无效',
        invalidRange: '结束时间必须晚于开始时间',
        totalActualCost: '实际计费用量',
        totalActualCostNote: '余额扣减与订阅消耗，按历史用量记录汇总',
        totalCost: '账面费用',
        totalCostNote: '使用记录中的标准定价费用',
        totalAccountCost: '上游账号成本',
        totalAccountCostNote: '使用每条记录的账号成本及历史倍率汇总',
        totalRequests: '已记录请求',
